...
export default function AssistantPanel({ onClose }) {
  ...
  function applyFilters() {
    ...
    if (suggestion.suggestedFilters.disciplines[0]) params.set('discipline', suggestion.suggestedFilters.disciplines[0])
    if (suggestion.suggestedFilters.styles[0]) params.set('style', suggestion.suggestedFilters.styles[0])
    if (suggestion.suggestedFilters.maxPrice) params.set('maxPrice', suggestion.suggestedFilters.maxPrice)
    if (suggestion.suggestedFilters.availability) params.set('availability', suggestion.suggestedFilters.availability)
